...
# Set form defaults
    ...
    if form.validate_on_submit():
        ...
        user.username = form.username.data if None else g.user.username
        user.email = form.email.data if None else g.user.email
        user.image_url = form.image_url.data if None else "/static/images/default-pic.png"
        user.header_image_url = form.header_image_url.data if None else "/static/images/warbler-hero.jpg"
        user.bio = form.bio.data if None else g.user.bio
